...
class TestUser(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.new_user = User("Mike","1994","mike@gmail.com") # create contact object
    ...
    def test_init(self):
        ...
        self.assertEqual(self.new_user.password,"1994")
        self.assertEqual(self.new_user.email,"mike@gmail.com")
...
class TestCredentials(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.new_credential = Credentials("instagram","mikengugy","1994") # create credential object
    ...
    def test_init(self):
        ...
        self.assertEqual(self.new_credential.account_username,"mikengugy")
        self.assertEqual(self.new_credential.account_password,"1994")
    ...
    def test_save_multiple_credential(self):
        ...
        test_credential = Credentials("facebook","ngugi_mike","1994") # new credential
    ...
    def test_delete_account(self):
        ...
        '''
        self.new_credential.save_credential()
        test_credential = Credentials("instagram","mikengugy","1994") # new credential
        test_credential.save_credential()
